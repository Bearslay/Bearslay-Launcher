...
namespace npp {
    ...
    class Window {
        ...
        public:
            ...
            /// @param wrap Whether to wrap to starting x or not
            /// @param usePadding Whether to disallow writing to cells that are in a padded region or not
            void wmstr(unsigned short y, unsigned short x, std::string input, unsigned char color = Defaults.Color, bool danglingLetters = Defaults.DanglingLetters, unsigned char kerning = Defaults.Kerning, unsigned char leading = Defaults.Leading, bool wrap = Defaults.Wrap) {wmstr({y, x}, input, color, danglingLetters, kerning, leading, wrap);}
            ...
            /// @param rev Whether to reverse the char-by-char direction of rendering (has no effect if full is true)
            /// @param millis Milliseconds to wait in between each line/character rendering
            void rlinetop(bool full = true, bool rev = false, unsigned long millis = 20) {rline(0, full, rev, millis);}
            ...
            /// @param rev Whether to reverse the char-by-char direction of rendering (has no effect if full is true)
            /// @param millis Milliseconds to wait in between each line/character rendering
            void rlinebot(bool full = true, bool rev = false, unsigned long millis = 20) {rline(1, full, rev, millis);}
            /// @brief Render by Line (from Left) - Render the window line-by-line (and char-by-char if indicated) from the left of the window
            /// @param full Whether to render the full line at once or not
            /// @param rev Whether to reverse the char-by-char direction of rendering (has no effect if full is true)
            /// @param millis Milliseconds to wait in between each line/character rendering
            void rlineleft(bool full = true, bool rev = false, unsigned long millis = 20) {rline(2, full, rev, millis);}
            ...
            /// @param rev Whether to reverse the char-by-char direction of rendering (has no effect if full is true)
            /// @param millis Milliseconds to wait in between each line/character rendering
            void rlineright(bool full = true, bool rev = false, unsigned long millis = 20) {rline(3, full, rev, millis);}
            ...
            /// @param mergeable Whether the line will be able to be merged with future lines
            /// @param canMerge Whether the line will be able to merge with pre-existing box-drawing characters
            void dvline(unsigned short y, unsigned short x, unsigned short length, bool rev = false, std::pair<unsigned char, unsigned char> style = Defaults.Style, unsigned char color = Defaults.Color, bool mergeable = Defaults.Mergeable, bool canMerge = Defaults.CanMerge) {dline(y, x, length, true, rev, style, color, mergeable, canMerge);}
            ...
            /// @param mergeable Whether the line will be able to be merged with future lines
            /// @param canMerge Whether the line will be able to merge with pre-existing box-drawing characters
            void dhline(unsigned short y, unsigned short x, unsigned short length, bool rev = false, std::pair<unsigned char, unsigned char> style = Defaults.Style, unsigned char color = Defaults.Color, bool mergeable = Defaults.Mergeable, bool canMerge = Defaults.CanMerge) {dline(y, x, length, false, rev, style, color, mergeable, canMerge);}
